...
void Test_NewtonCoef()
{
    ...
    StationaryOrbit::NumericAnalysis::NewtonCoef comp = StationaryOrbit::NumericAnalysis::NewtonCoef(StationaryOrbit::NumericAnalysis::MathmaticFunction<double>(exp), mpt);
