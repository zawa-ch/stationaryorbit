...
const IMathematicFunction<double>& MidpointIntegral::Function() const
{ return _func; }

Range<double, true, true> MidpointIntegral::getIntegrationRange() const
{ return _irange; }

double MidpointIntegral::Calc(const double& value) const
{
